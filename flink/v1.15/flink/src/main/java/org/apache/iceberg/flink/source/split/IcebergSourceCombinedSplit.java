...
public class IcebergSourceCombinedSplit extends IcebergSourceSplit<FileScanTask, CombinedScanTask> {
  ...
  @Override
  protected String toString(Collection<FileScanTask> files) {
