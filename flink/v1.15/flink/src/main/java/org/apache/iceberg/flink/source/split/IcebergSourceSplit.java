...
@Internal
public abstract class IcebergSourceSplit<S extends ScanTask, G extends ScanTaskGroup<S>>
  ...
  protected IcebergSourceSplit(G task, int fileOffset, long recordOffset) {
    this.task = task;
  ...
  protected abstract String toString(Collection<S> files);
